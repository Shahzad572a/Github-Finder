                 ...
                 <figure>
                        <img src={avatar_url} alt="" />
                                     ...
                                     <div className='card-body justify-end'>
                                        <h2 className='card-title mb-0'>{name}
                                            </h2>
                                                 <p>{login}</p>
                                                                </div>
                                                                      </div>
    ...
    <div className='col-span-2'>
        <div className='mb-6'>
            <h1 className='text-3xl card-title'>
                    {name}
                <div className='ml-2 mr-1 badge badge-success'>{type}
                    </div>
            {hireable && (
                          <div className='mx-1 badge badge-info'>Hireable
                              </div>
            )}
                                    </h1>
                                         <p>{bio}
        ...
        <a 
          ...
          <div className='stat'>
            ...
            Folowing
                               ...
                               <div className='stat-value pr-5 text-3xl md:text-4xl'>{folowing}</div>
                                   </div>
